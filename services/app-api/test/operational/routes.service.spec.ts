...
describe('RoutesService', () => {
  ...
  it('should optimize stop order via Mapbox and save history', async () => {
    prisma.routes.findFirst.mockResolvedValue(mockRoute);
    prisma.route_stops.findMany
      .mockResolvedValueOnce(mockStops)   // first call: fetch stops for optimization
      .mockResolvedValueOnce(mockStops);  // second call: fetch afterStops
